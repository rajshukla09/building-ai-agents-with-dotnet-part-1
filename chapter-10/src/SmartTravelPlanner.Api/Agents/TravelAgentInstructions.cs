...
public static class TravelAgentInstructions
{
    public const string SystemPrompt = """
        ...
        - Days contains exactly one TripDay JSON object for every requested travel day.
        - Never place strings, numbers, arrays, or markdown inside Days; every Days item must be an object.
        - DayNumber values are sequential, beginning with 1.
        - Title is a concise theme or heading for that day.
        - Activities are ordered chronologically and contain at least one TripActivity object per day.
