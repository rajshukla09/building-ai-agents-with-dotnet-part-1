...
public sealed class TravelAgent : ITravelAgent
{
    ...
    public async Task<AgentSession> CloneSessionAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        System.Text.Json.JsonElement state = await _agent.SerializeSessionAsync(
            session,
            cancellationToken: cancellationToken);
        return await _agent.DeserializeSessionAsync(state, cancellationToken: cancellationToken);
    }
    ...
    {
        _logger.LogInformation("Travel agent streaming conversation turn starting");
        ...
        _logger.LogInformation("Travel agent streaming conversation turn completed");
    }
