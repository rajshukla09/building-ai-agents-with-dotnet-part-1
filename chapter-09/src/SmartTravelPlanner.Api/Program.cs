...
builder.Services.AddSingleton<IExecutionPlanExecutor, ExecutionPlanExecutor>();
...
app.UseExceptionHandler(errorApp =>
{
    errorApp.Run(async context =>
    {
        ...
        int statusCode = classificationError
            ? StatusCodes.Status422UnprocessableEntity
            : StatusCodes.Status500InternalServerError;
        context.Response.StatusCode = statusCode;
        await Results.Problem(
            statusCode: statusCode,
            title: classificationError ? "The request could not be classified" : "Unable to create a travel plan",
